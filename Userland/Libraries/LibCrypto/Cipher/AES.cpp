...
using i64llx2 = long long __attribute__((vector_size(16)));
...
static void __attribute__((target("aes"), used)) AESCipherKey_expand_encrypt_key_128(u32* round_key, ReadonlyBytes user_key)
{
    ...
    tb = bit_cast<AK::SIMD::i64x2>(__builtin_ia32_aeskeygenassist128(bit_cast<i64llx2>(ta), 0x01));
    ta = AESCipherKey_expand_encrypt_key_128_assist(ta, tb);
    AK::SIMD::store_unaligned(&round_key[1 * 4], ta);
    tb = bit_cast<AK::SIMD::i64x2>(__builtin_ia32_aeskeygenassist128(bit_cast<i64llx2>(ta), 0x02));
    ta = AESCipherKey_expand_encrypt_key_128_assist(ta, tb);
    AK::SIMD::store_unaligned(&round_key[2 * 4], ta);
    tb = bit_cast<AK::SIMD::i64x2>(__builtin_ia32_aeskeygenassist128(bit_cast<i64llx2>(ta), 0x04));
    ta = AESCipherKey_expand_encrypt_key_128_assist(ta, tb);
    AK::SIMD::store_unaligned(&round_key[3 * 4], ta);
    tb = bit_cast<AK::SIMD::i64x2>(__builtin_ia32_aeskeygenassist128(bit_cast<i64llx2>(ta), 0x08));
    ta = AESCipherKey_expand_encrypt_key_128_assist(ta, tb);
    AK::SIMD::store_unaligned(&round_key[4 * 4], ta);
    tb = bit_cast<AK::SIMD::i64x2>(__builtin_ia32_aeskeygenassist128(bit_cast<i64llx2>(ta), 0x10));
    ta = AESCipherKey_expand_encrypt_key_128_assist(ta, tb);
    AK::SIMD::store_unaligned(&round_key[5 * 4], ta);
    tb = bit_cast<AK::SIMD::i64x2>(__builtin_ia32_aeskeygenassist128(bit_cast<i64llx2>(ta), 0x20));
    ta = AESCipherKey_expand_encrypt_key_128_assist(ta, tb);
    AK::SIMD::store_unaligned(&round_key[6 * 4], ta);
    tb = bit_cast<AK::SIMD::i64x2>(__builtin_ia32_aeskeygenassist128(bit_cast<i64llx2>(ta), 0x40));
    ta = AESCipherKey_expand_encrypt_key_128_assist(ta, tb);
    AK::SIMD::store_unaligned(&round_key[7 * 4], ta);
    tb = bit_cast<AK::SIMD::i64x2>(__builtin_ia32_aeskeygenassist128(bit_cast<i64llx2>(ta), 0x80));
    ta = AESCipherKey_expand_encrypt_key_128_assist(ta, tb);
    AK::SIMD::store_unaligned(&round_key[8 * 4], ta);
    tb = bit_cast<AK::SIMD::i64x2>(__builtin_ia32_aeskeygenassist128(bit_cast<i64llx2>(ta), 0x1b));
    ta = AESCipherKey_expand_encrypt_key_128_assist(ta, tb);
    AK::SIMD::store_unaligned(&round_key[9 * 4], ta);
    tb = bit_cast<AK::SIMD::i64x2>(__builtin_ia32_aeskeygenassist128(bit_cast<i64llx2>(ta), 0x36));
    ta = AESCipherKey_expand_encrypt_key_128_assist(ta, tb);
...
#    define ROUND(i1, i2, i3, k1, k2)                                                                  \
        td = tb;                                                                                       \
        tc = bit_cast<AK::SIMD::i32x4>(__builtin_ia32_aeskeygenassist128(bit_cast<i64llx2>(tb), k1));  \
        ...
        tc = bit_cast<AK::SIMD::i32x4>(__builtin_ia32_aeskeygenassist128(bit_cast<i64llx2>(tb), k2));  \
        AESCipherKey_expand_encrypt_key_192_assist(ta, tc, tb);                                        \
...
static void __attribute__((target("aes"), used)) AESCipherKey_expand_encrypt_key_256_assist_b(AK::SIMD::i64x2 const& a, AK::SIMD::i64x2& b)
{
    ...
    tb = bit_cast<AK::SIMD::i32x4>(b);
    tc = bit_cast<AK::SIMD::i32x4>(__builtin_ia32_aeskeygenassist128(bit_cast<i64llx2>(a), 0x00));
...
static void __attribute__((target("aes"), used)) AESCipherKey_expand_encrypt_key_256(u32* round_key, ReadonlyBytes user_key)
{
    ...
    tc = bit_cast<AK::SIMD::i64x2>(bit_cast<AK::SIMD::i32x4>(__builtin_ia32_aeskeygenassist128(bit_cast<i64llx2>(tb), 0x01)));
    ...
    tc = bit_cast<AK::SIMD::i64x2>(bit_cast<AK::SIMD::i32x4>(__builtin_ia32_aeskeygenassist128(bit_cast<i64llx2>(tb), 0x02)));
    AESCipherKey_expand_encrypt_key_256_assist_a(ta, tc);
    AK::SIMD::store_unaligned(&round_key[4 * 4], ta);
    AESCipherKey_expand_encrypt_key_256_assist_b(ta, tb);
    AK::SIMD::store_unaligned(&round_key[5 * 4], tb);
    tc = bit_cast<AK::SIMD::i64x2>(bit_cast<AK::SIMD::i32x4>(__builtin_ia32_aeskeygenassist128(bit_cast<i64llx2>(tb), 0x04)));
    AESCipherKey_expand_encrypt_key_256_assist_a(ta, tc);
    AK::SIMD::store_unaligned(&round_key[6 * 4], ta);
    AESCipherKey_expand_encrypt_key_256_assist_b(ta, tb);
    AK::SIMD::store_unaligned(&round_key[7 * 4], tb);
    tc = bit_cast<AK::SIMD::i64x2>(bit_cast<AK::SIMD::i32x4>(__builtin_ia32_aeskeygenassist128(bit_cast<i64llx2>(tb), 0x08)));
    AESCipherKey_expand_encrypt_key_256_assist_a(ta, tc);
    AK::SIMD::store_unaligned(&round_key[8 * 4], ta);
    AESCipherKey_expand_encrypt_key_256_assist_b(ta, tb);
    AK::SIMD::store_unaligned(&round_key[9 * 4], tb);
    tc = bit_cast<AK::SIMD::i64x2>(bit_cast<AK::SIMD::i32x4>(__builtin_ia32_aeskeygenassist128(bit_cast<i64llx2>(tb), 0x10)));
    AESCipherKey_expand_encrypt_key_256_assist_a(ta, tc);
    AK::SIMD::store_unaligned(&round_key[10 * 4], ta);
    AESCipherKey_expand_encrypt_key_256_assist_b(ta, tb);
    AK::SIMD::store_unaligned(&round_key[11 * 4], tb);
    tc = bit_cast<AK::SIMD::i64x2>(bit_cast<AK::SIMD::i32x4>(__builtin_ia32_aeskeygenassist128(bit_cast<i64llx2>(tb), 0x20)));
    AESCipherKey_expand_encrypt_key_256_assist_a(ta, tc);
    AK::SIMD::store_unaligned(&round_key[12 * 4], ta);
    AESCipherKey_expand_encrypt_key_256_assist_b(ta, tb);
    AK::SIMD::store_unaligned(&round_key[13 * 4], tb);
    tc = bit_cast<AK::SIMD::i64x2>(bit_cast<AK::SIMD::i32x4>(__builtin_ia32_aeskeygenassist128(bit_cast<i64llx2>(tb), 0x40)));
    AESCipherKey_expand_encrypt_key_256_assist_a(ta, tc);
...
static void __attribute__((target("aes"), used)) AESCipherKey_expand_decrypt_key(u32* round_key, ReadonlyBytes user_key, size_t bits)
{
    ...
    for (int i_round = 1; i_round != n_rounds; ++i_round) {
        ...
        ta = bit_cast<AK::SIMD::i64x2>(__builtin_ia32_aesimc128(bit_cast<i64llx2>(ta)));
...
static void __attribute__((target("aes"), used)) AESCipher_encrypt_block(AESCipherKey const& key, AESCipherBlock const& in, AESCipherBlock& out)
{
    ...
    for (int i_round = 0; i_round != n_rounds - 1; ++i_round) {
        ...
        value = bit_cast<AK::SIMD::i64x2>(__builtin_ia32_aesenc128(bit_cast<i64llx2>(value), bit_cast<i64llx2>(round_key)));
    }
    round_key = AK::SIMD::load_unaligned<AK::SIMD::i64x2>(&round_keys[(1 + (n_rounds - 1)) * 4]);
    value = bit_cast<AK::SIMD::i64x2>(__builtin_ia32_aesenclast128(bit_cast<i64llx2>(value), bit_cast<i64llx2>(round_key)));
...
static void __attribute__((target("aes"), used)) AESCipher_decrypt_block(AESCipherKey const& key, AESCipherBlock const& in, AESCipherBlock& out)
{
    ...
    for (int i_round = 0; i_round != n_rounds - 1; ++i_round) {
        ...
        value = bit_cast<AK::SIMD::i64x2>(__builtin_ia32_aesdec128(bit_cast<i64llx2>(value), bit_cast<i64llx2>(round_key)));
    }
    round_key = AK::SIMD::load_unaligned<AK::SIMD::i64x2>(&round_keys[0]);
    value = bit_cast<AK::SIMD::i64x2>(__builtin_ia32_aesdeclast128(bit_cast<i64llx2>(value), bit_cast<i64llx2>(round_key)));
    AK::SIMD::store_unaligned(output_ptr, value);
}
#endif
