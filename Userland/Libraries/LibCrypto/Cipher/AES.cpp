...
#if (ARCH(I386) || ARCH(X86_64))
[[gnu::target("default")]] static void AESCipherKey_expand_encrypt_key(u32* round_key, ReadonlyBytes user_key, size_t bits)
#else
...
#if (ARCH(I386) || ARCH(X86_64))
[[gnu::target("aes,sse4.2"), gnu::used]] static auto AESCipherKey_expand_encrypt_key_128_assist(auto const& a, auto const& b)
{
    AK::SIMD::i32x4 ta {};
    AK::SIMD::i32x4 tb {};
    AK::SIMD::i32x4 tc {};
...
[[gnu::target("aes,sse4.2"), gnu::used]] static void AESCipherKey_expand_encrypt_key_128(u32* round_key, ReadonlyBytes user_key)
{
...
[[gnu::target("aes,sse4.2"), gnu::used]] static void AESCipherKey_expand_encrypt_key_192_assist(AK::SIMD::i32x4& a, AK::SIMD::i32x4& b, AK::SIMD::i32x4& c)
{
    AK::SIMD::i32x4 ta {};
    AK::SIMD::i32x4 tb {};
    AK::SIMD::i32x4 tc {};
...
[[gnu::target("aes,sse4.2"), gnu::used]] static void AESCipherKey_expand_encrypt_key_192(u32* round_key, ReadonlyBytes user_key)
{
    using illx2 = signed long long int __attribute__((vector_size(16)));
...
[[gnu::target("aes,sse4.2"), gnu::used]] static void AESCipherKey_expand_encrypt_key_256_assist_a(AK::SIMD::i64x2& a, AK::SIMD::i64x2& b)
{
    AK::SIMD::i32x4 ta {};
    AK::SIMD::i32x4 tb {};
    AK::SIMD::i32x4 tc {};
...
[[gnu::target("aes,sse4.2"), gnu::used]] static void AESCipherKey_expand_encrypt_key_256_assist_b(AK::SIMD::i64x2 const& a, AK::SIMD::i64x2& b)
{
    using illx2 = signed long long int __attribute__((vector_size(16)));
...
[[gnu::target("aes,sse4.2"), gnu::used]] static void AESCipherKey_expand_encrypt_key_256(u32* round_key, ReadonlyBytes user_key)
{
    using illx2 = signed long long int __attribute__((vector_size(16)));
...
[[gnu::target("aes,sse4.2"), gnu::used]] static void AESCipherKey_expand_encrypt_key(u32* round_key, ReadonlyBytes user_key, size_t bits)
{
    switch (bits) {
    case 128:
...
#if (ARCH(I386) || ARCH(X86_64))
[[gnu::target("default")]] static void AESCipherKey_expand_decrypt_key(u32* round_key, ReadonlyBytes user_key, size_t bits)
#else
...
#if (ARCH(I386) || ARCH(X86_64))
[[gnu::target("aes,sse4.2"), gnu::used]] static void AESCipherKey_expand_decrypt_key(u32* round_key, ReadonlyBytes user_key, size_t bits)
{
    using illx2 = signed long long int __attribute__((vector_size(16)));
...
#if (ARCH(I386) || ARCH(X86_64))
[[gnu::target("default")]] static void AESCipher_encrypt_block(AESCipherKey const& key, AESCipherBlock const& in, AESCipherBlock& out)
#else
...
#if (ARCH(I386) || ARCH(X86_64))
[[gnu::target("aes,sse4.2"), gnu::used]] static void AESCipher_encrypt_block(AESCipherKey const& key, AESCipherBlock const& in, AESCipherBlock& out)
{
    using illx2 = signed long long int __attribute__((vector_size(16)));
...
#if (ARCH(I386) || ARCH(X86_64))
[[gnu::target("default")]] static void AESCipher_decrypt_block(AESCipherKey const& key, AESCipherBlock const& in, AESCipherBlock& out)
#else
...
#if (ARCH(I386) || ARCH(X86_64))
[[gnu::target("aes,sse4.2"), gnu::used]] static void AESCipher_decrypt_block(AESCipherKey const& key, AESCipherBlock const& in, AESCipherBlock& out)
{
    using illx2 = signed long long int __attribute__((vector_size(16)));
