...
static AK::SIMD::i64x2 AESCipherKey_expand_encrypt_key_128_assist(AK::SIMD::i64x2 const& a, AK::SIMD::i64x2 const& b)
{
    ...
    ta = AK::SIMD::as<AK::SIMD::i32x4>(a);
    tb = AK::SIMD::as<AK::SIMD::i32x4>(b);
    ...
    ta ^= tc;
    ta ^= tb;
    return AK::SIMD::as<AK::SIMD::i64x2>(ta);
}
}
#endif
...
static void __attribute__((target("aes"), used)) AESCipherKey_expand_encrypt_key_128(u32* round_key, ReadonlyBytes user_key)
{
    ...
    tb = __builtin_ia32_aeskeygenassist128(ta, 0x01); ta = AESCipherKey_expand_encrypt_key_128_assist(ta, tb); AK::SIMD::store_unaligned(&round_key[ 1 * 4], ta);
    tb = __builtin_ia32_aeskeygenassist128(ta, 0x02); ta = AESCipherKey_expand_encrypt_key_128_assist(ta, tb); AK::SIMD::store_unaligned(&round_key[ 2 * 4], ta);
    tb = __builtin_ia32_aeskeygenassist128(ta, 0x04); ta = AESCipherKey_expand_encrypt_key_128_assist(ta, tb); AK::SIMD::store_unaligned(&round_key[ 3 * 4], ta);
    tb = __builtin_ia32_aeskeygenassist128(ta, 0x08); ta = AESCipherKey_expand_encrypt_key_128_assist(ta, tb); AK::SIMD::store_unaligned(&round_key[ 4 * 4], ta);
    tb = __builtin_ia32_aeskeygenassist128(ta, 0x10); ta = AESCipherKey_expand_encrypt_key_128_assist(ta, tb); AK::SIMD::store_unaligned(&round_key[ 5 * 4], ta);
    tb = __builtin_ia32_aeskeygenassist128(ta, 0x20); ta = AESCipherKey_expand_encrypt_key_128_assist(ta, tb); AK::SIMD::store_unaligned(&round_key[ 6 * 4], ta);
    tb = __builtin_ia32_aeskeygenassist128(ta, 0x40); ta = AESCipherKey_expand_encrypt_key_128_assist(ta, tb); AK::SIMD::store_unaligned(&round_key[ 7 * 4], ta);
    tb = __builtin_ia32_aeskeygenassist128(ta, 0x80); ta = AESCipherKey_expand_encrypt_key_128_assist(ta, tb); AK::SIMD::store_unaligned(&round_key[ 8 * 4], ta);
    tb = __builtin_ia32_aeskeygenassist128(ta, 0x1b); ta = AESCipherKey_expand_encrypt_key_128_assist(ta, tb); AK::SIMD::store_unaligned(&round_key[ 9 * 4], ta);
    tb = __builtin_ia32_aeskeygenassist128(ta, 0x36); ta = AESCipherKey_expand_encrypt_key_128_assist(ta, tb); AK::SIMD::store_unaligned(&round_key[10 * 4], ta);
}
}
#endif
...
static void AESCipherKey_expand_encrypt_key_192_assist(AK::SIMD::i32x4& a, AK::SIMD::i32x4& b, AK::SIMD::i32x4& c)
{
    ...
    tc ^= td;
    tc ^= tb;
    a = AK::SIMD::as<AK::SIMD::i64x2>(ta);
    b = AK::SIMD::as<AK::SIMD::i64x2>(tb);
    c = AK::SIMD::as<AK::SIMD::i64x2>(tc);
}
}
#endif
...
static void __attribute__((target("aes"), used)) AESCipherKey_expand_encrypt_key_192(u32* round_key, ReadonlyBytes user_key)
{
    ...
    memcpy(&buf.m_buf[0 * 8], &user_ptr[1 * 16], 8);
    memset(&buf.m_buf[1 * 8], 0x00, 8);
    tb = AK::SIMD::load_unaligned<AK::SIMD::i32x4>(&buf.m_buf[0]);
    AK::SIMD::store_unaligned(&round_key[0 * 4], ta);
    td = tb;
    tc = __builtin_ia32_aeskeygenassist128(tb, 0x01);
    AESCipherKey_expand_encrypt_key_192_assist(ta, tc, tb);
    AK::SIMD::store_unaligned(&round_key[1 * 4], AK::SIMD::i32x4{td[0], td[1], ta[0], ta[1]});
    AK::SIMD::store_unaligned(&round_key[2 * 4], AK::SIMD::i32x4{ta[2], ta[3], tb[0], tb[1]});
    ...
    AESCipherKey_expand_encrypt_key_192_assist(ta, tc, tb);
    AK::SIMD::store_unaligned(&round_key[4 * 4], AK::SIMD::i32x4{td[0], td[1], ta[0], ta[1]});
    AK::SIMD::store_unaligned(&round_key[5 * 4], AK::SIMD::i32x4{ta[2], ta[3], tb[0], tb[1]});
    ...
    AESCipherKey_expand_encrypt_key_192_assist(ta, tc, tb);
    AK::SIMD::store_unaligned(&round_key[7 * 4], AK::SIMD::i32x4{td[0], td[1], ta[0], ta[1]});
    AK::SIMD::store_unaligned(&round_key[8 * 4], AK::SIMD::i32x4{ta[2], ta[3], tb[0], tb[1]});
    ...
    AESCipherKey_expand_encrypt_key_192_assist(ta, tc, tb);
    AK::SIMD::store_unaligned(&round_key[10 * 4], AK::SIMD::i32x4{td[0], td[1], ta[0], ta[1]});
    AK::SIMD::store_unaligned(&round_key[11 * 4], AK::SIMD::i32x4{ta[2], ta[3], tb[0], tb[1]});
    tc = __builtin_ia32_aeskeygenassist128(tb, 0x80);
    AESCipherKey_expand_encrypt_key_192_assist(ta, tc, tb);
...
static void __attribute__((target("aes"), used)) AESCipherKey_expand_encrypt_key_256_assist_b(AK::SIMD::i64x2 const& a, AK::SIMD::i64x2& b)
{
    ...
    tb = AK::SIMD::as<AK::SIMD::i32x4>(b);
    tc = AK::SIMD::as<AK::SIMD::i32x4>(__builtin_ia32_aeskeygenassist128(a, 0x00));
...
static void __attribute__((target("aes"), used)) AESCipherKey_expand_encrypt_key_256(u32* round_key, ReadonlyBytes user_key)
{
    ...
    tc = __builtin_ia32_aeskeygenassist128(tb, 0x01); AESCipherKey_expand_encrypt_key_256_assist_a(ta, tc); AK::SIMD::store_unaligned(&round_key[ 2 * 4], ta); AESCipherKey_expand_encrypt_key_256_assist_b(ta, tb); AK::SIMD::store_unaligned(&round_key[ 3 * 4], tb);
    tc = __builtin_ia32_aeskeygenassist128(tb, 0x02); AESCipherKey_expand_encrypt_key_256_assist_a(ta, tc); AK::SIMD::store_unaligned(&round_key[ 4 * 4], ta); AESCipherKey_expand_encrypt_key_256_assist_b(ta, tb); AK::SIMD::store_unaligned(&round_key[ 5 * 4], tb);
    tc = __builtin_ia32_aeskeygenassist128(tb, 0x04); AESCipherKey_expand_encrypt_key_256_assist_a(ta, tc); AK::SIMD::store_unaligned(&round_key[ 6 * 4], ta); AESCipherKey_expand_encrypt_key_256_assist_b(ta, tb); AK::SIMD::store_unaligned(&round_key[ 7 * 4], tb);
...
static void __attribute__((target("aes"), used)) AESCipherKey_expand_encrypt_key(u32* round_key, ReadonlyBytes user_key, size_t bits)
{
    switch(bits)
    {
        case 128: AESCipherKey_expand_encrypt_key_128(round_key, user_key); break;
        case 192: AESCipherKey_expand_encrypt_key_192(round_key, user_key); break;
        case 256: AESCipherKey_expand_encrypt_key_256(round_key, user_key); break;
    }
}
#endif
...
#endif
{
    ...
    int rounds = bits == 128 ? 10 : bits == 192 ? 12 : bits == 256 ? 14 : -1;
    // reorder round keys
...
{
    AESCipherKey_expand_encrypt_key(round_key, user_key, bits);
    int const n_rounds = bits == 128 ? 10 : bits == 192 ? 12 : bits == 256 ? 14 : -1;
